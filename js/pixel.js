...
PixelJS.Player.prototype.update = function (elapsedTime, dt) {
    if (this.allowDiagonalMovement) {
        //CASE 1: UP AND RIGHT
        if (((this.direction & PixelJS.Directions.Right) != 0) & ((this.direction & PixelJS.Directions.Up) != 0)) {
        ...
        //CASE 2: UP AND LEFT
        else if (((this.direction & PixelJS.Directions.Left) != 0) & ((this.direction & PixelJS.Directions.Up) != 0)) {
          if (this.isAnimatedSprite) {
              this.asset.startAnimating();
              this.asset.row = this._directionRowMap.up;
          }
        ...
        else if (((this.direction & PixelJS.Directions.Right) != 0) & ((this.direction & PixelJS.Directions.Down) != 0)) {
          if (this.isAnimatedSprite) {
              this.asset.startAnimating();
        ...
        else if (((this.direction & PixelJS.Directions.Left) != 0) & ((this.direction & PixelJS.Directions.Down) != 0)) {
          if (this.isAnimatedSprite) {
              this.asset.startAnimating();
              this.asset.row = this._directionRowMap.down;
          }
